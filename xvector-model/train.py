#!/usr/bin/env python3
"""This recipe for training a speaker-id system from SpeechBrain has been modified to suit the 
binary classification task of detecting PD with the PC-GITA database. The changes made to the file
are shown here.
...
class SpkIdBrain(sb.Brain):
    ...
    def compute_forward(self, batch, stage):
        ...
        predictions = self.modules.classifier(embeddings).squeeze()
